...
class ParamsScreen extends SimpleScreen {
  ParamsScreen({Key? key}) : super(key: key, stateInfo: AppScreenStateInfo(fabIcon: Icons.add, refreshInterval: 60));

  @override
  State<ParamsScreen> createState() => ParamsScreenState();
}

class ParamsScreenState extends SimpleScreenState<ParamsScreen> {
  @override
  void initState() {
    super.initState();
            ...
            BootstrapCol(
              ...
              child: SizedBox(
                ...
                child: TitledCard(
                  ...
                  backChild: const Column(children: [Text("Flipped Card")]),
