...
class DefaultTextButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      onTap:
          disabled && onDisabledPressed != null
              ? () {
                onDisabledPressed!();
              }
              : null,
      child: TextButton(
        ...
        autofocus: autoFocus,
        style: ButtonStyle(
          fixedSize: WidgetStateProperty.all(Size(width ?? double.infinity, height ?? double.infinity)),
          ...
          shape: WidgetStateProperty.all(
            RoundedRectangleBorder(
              side:
                  borderSide?.copyWith(
                    color: borderSide!.color.withValues(alpha: borderSide!.color.a * (disabled ? 0.25 : 1)),
                  ) ??
                  BorderSide.none,
