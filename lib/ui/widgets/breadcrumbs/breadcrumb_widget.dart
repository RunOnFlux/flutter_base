...
class BreadCrumbTile extends StatelessWidget {
  ...
  const BreadCrumbTile({super.key, required this.breadCrumbItem});
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Material(
        ...
        shape: RoundedRectangleBorder(borderRadius: breadCrumbItem.borderRadius, side: breadCrumbItem.border),
        child: InkWell(
