...
import 'breadcrumb_overflow.dart';
...
class BreadCrumb extends StatelessWidget {
  ...
  const BreadCrumb({super.key, required this.items, this.divider, this.overflow = const WrapOverflow()})
  ...
  factory BreadCrumb.builder({
    ...
    items: List<BreadCrumbItem>.generate(itemCount, (i) => builder(i)),
    divider: divider,
    overflow: overflow,
  );
