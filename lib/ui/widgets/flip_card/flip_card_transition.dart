  ...
  Widget _buildContent({required Widget child}) {
    ...
    return IgnorePointer(
      ...
      child: FlipTransition(
        animation:
            isFront
                ? (widget.frontAnimator ?? FlipCardTransition.defaultFrontAnimator).animate(widget.animation)
                : (widget.backAnimator ?? FlipCardTransition.defaultBackAnimator).animate(widget.animation),
