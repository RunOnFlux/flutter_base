...
class SuperScaffold extends StatefulWidget {
  ...
  @override
  SuperScaffoldState createState() => SuperScaffoldState();
}

class SuperScaffoldState extends State<SuperScaffold> {
  ...
  PreferredSize? _buildAppBar() {
    return widget.appBar != null
        ? PreferredSize(
            preferredSize:
                Size.fromHeight(AppBar().preferredSize.height + (page != null && page!.hasTabs ? kToolbarHeight : 0)),
            child: widget.appBar!,
          )
        : null;
  }
  ...
  Widget _buildScaffold(BuildContext context) {
    return Scaffold(
      ...
      drawer: (MediaQuery.of(context).size.width >= desktopBreakpoint) ? null : widget.drawer,
